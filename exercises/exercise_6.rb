...
@store2.employees.create(first_name: 'NAME2', last_name: 'Virani', hourly_rate: 25)
@store1.employees.create(first_name: 'NAME3', last_name: 'Virani', hourly_rate: 10)
@store2.employees.create(first_name: 'NAME4', last_name: 'Virani', hourly_rate: 5)
